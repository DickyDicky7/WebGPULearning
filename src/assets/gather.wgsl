...
//  let progressivePixelSamplesScale: f32 = 1.0 / frameCount;
    textureStore(outputTexture, vec2<u32>(gid.xy), outputStorage[pixelIndex] * progressivePixelSamplesScale);
//  textureStore(outputTexture, vec2<u32>(gid.xy), outputStorage[pixelIndex] * progressivePixelSamplesScale);
    */
    textureStore(outputTexture, vec2<u32>(gid.xy), outputStorage[pixelIndex]);
//  textureStore(outputTexture, vec2<u32>(gid.xy), outputStorage[pixelIndex]);
}
